...
const PlayerInfo = ({ player }: PlayerInfoProps) => (
  <View className="flex flex-row flex-wrap justify-between px-4 py-4">
    <View className="mb-4 w-full items-center rounded-lg border border-gray-800 bg-gray-920 p-3">
      <Text className="pbk-b3 text-gray-500">SALARY</Text>
    ...
    <View className="mb-4 w-[48%] items-center rounded-lg border border-gray-800 bg-gray-920 p-4">
      <Text className="pbk-b3 text-gray-500">RANK</Text>
      {/* TODO: Add rank when available */}
      <Text className="pbk-h7 mt-1 text-base-white">--</Text>
    </View>
    <View className="mb-4 w-[48%] items-center rounded-lg border border-gray-800 bg-gray-920 p-4">
      <Text className="pbk-b3 text-gray-500">POSITION</Text>
      <Text className="pbk-h7 mt-1 text-base-white">
        {player.positions.join(", ")}
      </Text>
    </View>
    <View className="mb-4 w-[48%] items-center rounded-lg border border-gray-800 bg-gray-920 p-4">
      <Text className="pbk-b3 text-gray-500">BIRTHDATE</Text>
